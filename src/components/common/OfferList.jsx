...
export default function OfferList(params = { className: "" }) {
	return (
		<div className={params.className + ""}>
			...
			<div className="mt-3 md:mt-5 flex justify-around">
				...
				<div className="text-center">
					...
					<Link href={"/"}>
						<div className="text-[#FF6432] font-medium mt-1 cursor-pointer">Забронировать</div>
					</Link>
				</div>
				<div className="text-center">
					...
					<Link href={"/"}>
						<div className="text-[#FF6432] font-medium mt-1 cursor-pointer">Заказать</div>
					</Link>
				</div>
			</div>
		</div>
