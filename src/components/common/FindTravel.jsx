            ...
            <div className="absolute top-12 md:top-20 -left-6 md:-left-10 flex flex-col gap-4 p-6 w-[352px] min-h-[225px] z-10 shadow-md bg-white rounded-lg">
              ...
              <div className="flex flex-row gap-2 justify-between">
                ...
                <div className="flex gap-6">
                  <img src="/img/minus.png" width={50} height={50} className="hover:shadow-md cursor-pointer"
                    onClick={() => { let temp = childrenNum - 1; if (temp > 0) setChildrenNum(temp); }} />
                  <div className="pt-2 class-p1">{childrenNum}</div>
                  <img src="/img/plus.png" width={50} height={50} className="hover:shadow-md cursor-pointer"
              ...
              hover:shadow-md cursor-pointer" onClick={() => { setExpandFlag(!expandFlag) }}>
                ...
                <div className="mt-1">
                  {expandFlag ? (<img src={'/img/arrow-down.png'} width={24} height={24} />
