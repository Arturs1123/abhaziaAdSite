				...
				<div className="mt-5 sm:mx-auto sm:w-full sm:max-w-sm">
					<div className="flex flex-col gap-2">
						<div className='text-center mt-5'>
							<img onClick={fileSelect} alt="avatar" className="rounded-8 border cursor-pointer object-cover rounded-[100px]" height={100} width={100} src={avatar?.path ? (avatar?.path) : "/icon/avatar.png"} />
